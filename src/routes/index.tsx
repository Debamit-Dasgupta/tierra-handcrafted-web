  ...
  return (
    <main id="home" className="bg-plaster text-ink paper-grain">
      ...
      <section className="bg-ink px-5 py-20 text-plaster md:px-10 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center"><figure className="border border-plaster/40 p-2"><img src={sandwichLatteImage} alt="Iced latte and a sandwich on checkered paper inside the café" width={1080} height={1920} loading="lazy" className="aspect-[4/3] w-full object-cover" /></figure><div><Eyebrow>Featured cup</Eyebrow><h2 className="font-display text-5xl uppercase leading-[0.9] sm:text-7xl">A little sweet.<br /><span className="text-sunflower">A lot of character.</span></h2><p className="mt-8 font-display text-2xl uppercase">Tres Leches Latte / Café de Olla</p><p className="mt-3 font-hand text-3xl text-pine">De La Tierra</p></div></div>
      </section>
