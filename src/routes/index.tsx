    ...
    <main id="home" className="bg-plaster text-ink paper-grain">
      ...
      <section className="grid h-[calc(100svh-72px)] grid-rows-[minmax(0,1.18fr)_minmax(0,0.82fr)] border-b border-ink md:grid-cols-[0.9fr_1.1fr] md:grid-rows-1">
        ...
        <figure className="relative min-h-0 overflow-hidden bg-ink">
          <img src={interiorImage} alt="Inside De La Tierra Café: reclaimed timber tables and benches under a wall of photographs" width={1920} height={1440} fetchPriority="high" className="h-full w-full object-cover" />
      ...
      <section className="px-5 py-20 md:px-10 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <figure className="relative min-w-0"><img src={counterImage} alt="Wooden table and stools beside the café counter" width={1080} height={1440} loading="lazy" className="h-full min-h-96 w-full object-cover" /><figcaption className="absolute bottom-3 left-3 bg-sunflower px-3 py-2 font-hand text-xl">made for taking your time</figcaption></figure>
