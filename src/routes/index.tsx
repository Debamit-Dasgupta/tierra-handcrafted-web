    ...
    <main id="home" className="bg-plaster text-ink paper-grain">
      ...
      <section className="px-5 py-20 md:px-10 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <figure className="relative min-w-0"><img src={sleeveLatteImage} alt="Iced latte in a De La Tierra branded sleeve on a worn timber table, café counter behind" width={1446} height={1920} loading="lazy" className="h-full min-h-96 w-full object-cover" /><figcaption className="absolute bottom-3 left-3 bg-sunflower px-3 py-2 font-hand text-xl">made for taking your time</figcaption></figure>
